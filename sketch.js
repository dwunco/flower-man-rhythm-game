...
function setup() {
    ...
    { bar: 49, beat: 1, semiquaver: 2, x: 375},
    { bar: 49, beat: 1, semiquaver: 3, x: 400},
    { bar: 49, beat: 2, semiquaver: 1, x: 400},
    { bar: 49, beat: 2, semiquaver: 3, x: 450},
    { bar: 49, beat: 2, semiquaver: 4, x: 425},
    { bar: 49, beat: 3, semiquaver: 1, x: 400},
    { bar: 49, beat: 3, semiquaver: 3, x: 400},
    { bar: 49, beat: 4, semiquaver: 1, x: 350},
    { bar: 49, beat: 4, semiquaver: 2, x: 375},
    { bar: 49, beat: 4, semiquaver: 3, x: 350},

    { bar: 50, beat: 1, semiquaver: 1, x: 300},
    { bar: 50, beat: 1, semiquaver: 3, x: 350},
    { bar: 50, beat: 1, semiquaver: 4, x: 375},
    { bar: 50, beat: 2, semiquaver: 1, x: 400},
    { bar: 50, beat: 2, semiquaver: 3, x: 450},
    { bar: 50, beat: 3, semiquaver: 1, x: 500},
    { bar: 50, beat: 3, semiquaver: 2, x: 525},
    { bar: 50, beat: 3, semiquaver: 3, x: 550},
    { bar: 50, beat: 4, semiquaver: 1, x: 500},
    { bar: 50, beat: 4, semiquaver: 3, x: 450},
    { bar: 50, beat: 4, semiquaver: 4, x: 475},

    { bar: 51, beat: 1, semiquaver: 1, x: 450}, // triplet
    { bar: 51, beat: 1, semiquaver: 4, x: 400},
    { bar: 51, beat: 2, semiquaver: 3, x: 350},
    { bar: 51, beat: 3, semiquaver: 1, x: 250}, // triplet
    { bar: 51, beat: 3, semiquaver: 4, x: 300},
    { bar: 51, beat: 4, semiquaver: 3, x: 350},

    { bar: 52, beat: 1, semiquaver: 1, x: 200},
    { bar: 52, beat: 2, semiquaver: 1, x: 600},
    { bar: 52, beat: 3, semiquaver: 1, x: 300},
    { bar: 52, beat: 4, semiquaver: 1, x: 500},

    { bar: 53, beat: 1, semiquaver: 1, x: 350},
    { bar: 53, beat: 3, semiquaver: 1, x: 450},

    { bar: 54, beat: 1, semiquaver: 1, x: 100}, // triplet
    { bar: 54, beat: 1, semiquaver: 4, x: 150},
    { bar: 54, beat: 2, semiquaver: 3, x: 200},
    { bar: 54, beat: 3, semiquaver: 1, x: 250}, // triplet
    { bar: 54, beat: 3, semiquaver: 4, x: 300},
    { bar: 54, beat: 4, semiquaver: 3, x: 350},

    { bar: 55, beat: 1, semiquaver: 1, x: 400},
    { bar: 55, beat: 3, semiquaver: 1, x: 500},

    { bar: 56, beat: 1, semiquaver: 1, x: 100},
    { bar: 56, beat: 2, semiquaver: 1, x: 300},
    { bar: 56, beat: 3, semiquaver: 1, x: 500},
    { bar: 56, beat: 4, semiquaver: 1, x: 700},

    { bar: 57, beat: 1, semiquaver: 1, x: 700},
    { bar: 57, beat: 2, semiquaver: 1, x: 600},
    { bar: 57, beat: 2, semiquaver: 3, x: 550},
    { bar: 57, beat: 3, semiquaver: 1, x: 500},
    { bar: 57, beat: 4, semiquaver: 1, x: 400},

    { bar: 58, beat: 1, semiquaver: 1, x: 100}, // triplet
    { bar: 58, beat: 1, semiquaver: 4, x: 175},
    { bar: 58, beat: 2, semiquaver: 3, x: 250},
    { bar: 58, beat: 3, semiquaver: 1, x: 300},
    { bar: 58, beat: 4, semiquaver: 1, x: 400},

    { bar: 59, beat: 1, semiquaver: 1, x: 700}, // triplet
    { bar: 59, beat: 1, semiquaver: 4, x: 625},
    { bar: 59, beat: 2, semiquaver: 3, x: 550},
    { bar: 59, beat: 3, semiquaver: 1, x: 500},
    { bar: 59, beat: 4, semiquaver: 1, x: 450},

    { bar: 60, beat: 1, semiquaver: 1, x: 300},
    { bar: 60, beat: 2, semiquaver: 1, x: 500},
    { bar: 60, beat: 3, semiquaver: 1, x: 300},
    { bar: 60, beat: 4, semiquaver: 1, x: 500},

    { bar: 61, beat: 1, semiquaver: 1, x: 400},
    { bar: 61, beat: 2, semiquaver: 3, x: 350},
    { bar: 61, beat: 2, semiquaver: 4, x: 375},
    { bar: 61, beat: 3, semiquaver: 1, x: 400},

    { bar: 62, beat: 1, semiquaver: 1, x: 125}, // triplet
    { bar: 62, beat: 1, semiquaver: 4, x: 150},
    { bar: 62, beat: 2, semiquaver: 3, x: 175},
    { bar: 62, beat: 3, semiquaver: 1, x: 250}, // triplet
    { bar: 62, beat: 3, semiquaver: 4, x: 275},
    { bar: 62, beat: 4, semiquaver: 3, x: 300},

    { bar: 63, beat: 1, semiquaver: 1, x: 350},
    { bar: 63, beat: 3, semiquaver: 1, x: 400},
    { bar: 63, beat: 4, semiquaver: 1, x: 400},

    { bar: 64, beat: 1, semiquaver: 1, x: 300},
    { bar: 64, beat: 2, semiquaver: 1, x: 500},
    { bar: 64, beat: 3, semiquaver: 1, x: 300},
    { bar: 64, beat: 4, semiquaver: 1, x: 500},

    // BRIDGE PART B
    { bar: 65, beat: 1, semiquaver: 1, x: 100},
    { bar: 65, beat: 4, semiquaver: 1, x: 700},
    { bar: 65, beat: 4, semiquaver: 3, x: 750},

    { bar: 66, beat: 3, semiquaver: 1, x: 300},
    { bar: 66, beat: 4, semiquaver: 1, x: 500},

    { bar: 67, beat: 1, semiquaver: 1, x: 700},
    { bar: 67, beat: 4, semiquaver: 1, x: 100},
    { bar: 67, beat: 4, semiquaver: 3, x: 50},

    { bar: 68, beat: 1, semiquaver: 3, x: 300},
    { bar: 68, beat: 2, semiquaver: 1, x: 350},
    { bar: 68, beat: 3, semiquaver: 1, x: 400},
    { bar: 68, beat: 4, semiquaver: 1, x: 500},

    { bar: 69, beat: 1, semiquaver: 1, x: 400},
    { bar: 69, beat: 4, semiquaver: 1, x: 200},
    { bar: 69, beat: 4, semiquaver: 3, x: 150},

    { bar: 70, beat: 2, semiquaver: 3, x: 200},
    { bar: 70, beat: 3, semiquaver: 1, x: 250},
    { bar: 70, beat: 4, semiquaver: 1, x: 400},
    { bar: 70, beat: 4, semiquaver: 3, x: 450},

    { bar: 71, beat: 3, semiquaver: 1, x: 700},
    { bar: 71, beat: 4, semiquaver: 1, x: 600},
    { bar: 71, beat: 4, semiquaver: 3, x: 500},

    { bar: 72, beat: 3, semiquaver: 1, x: 400},
    { bar: 72, beat: 4, semiquaver: 1, x: 400},

    { bar: 73, beat: 1, semiquaver: 1, x: 100},
    { bar: 73, beat: 4, semiquaver: 1, x: 700},
    { bar: 73, beat: 4, semiquaver: 3, x: 750},

    { bar: 74, beat: 3, semiquaver: 1, x: 300},
    { bar: 74, beat: 4, semiquaver: 1, x: 500},

    { bar: 75, beat: 1, semiquaver: 1, x: 700},
    { bar: 75, beat: 4, semiquaver: 1, x: 100},
    { bar: 75, beat: 4, semiquaver: 3, x: 50},

    { bar: 76, beat: 1, semiquaver: 3, x: 300},
    { bar: 76, beat: 2, semiquaver: 1, x: 350},
    { bar: 76, beat: 3, semiquaver: 1, x: 400},
    { bar: 76, beat: 4, semiquaver: 1, x: 500},

    { bar: 77, beat: 1, semiquaver: 1, x: 400},
    { bar: 77, beat: 4, semiquaver: 1, x: 200},
    { bar: 77, beat: 4, semiquaver: 3, x: 150},

    { bar: 78, beat: 1, semiquaver: 3, x: 200},
    { bar: 78, beat: 2, semiquaver: 1, x: 250},
    { bar: 78, beat: 3, semiquaver: 1, x: 350},
    { bar: 78, beat: 4, semiquaver: 1, x: 450},

    { bar: 79, beat: 1, semiquaver: 1, x: 400}, // long note start
    { bar: 79, beat: 1, semiquaver: 2, x: 400},
    { bar: 79, beat: 1, semiquaver: 3, x: 400},
    { bar: 79, beat: 1, semiquaver: 4, x: 400},
    { bar: 79, beat: 2, semiquaver: 1, x: 400},
    { bar: 79, beat: 2, semiquaver: 2, x: 400},
    { bar: 79, beat: 2, semiquaver: 3, x: 400},
    { bar: 79, beat: 2, semiquaver: 4, x: 400},
    { bar: 79, beat: 3, semiquaver: 1, x: 400},
    { bar: 79, beat: 3, semiquaver: 2, x: 400},
    { bar: 79, beat: 3, semiquaver: 3, x: 400},
    { bar: 79, beat: 3, semiquaver: 4, x: 400},
    { bar: 79, beat: 4, semiquaver: 1, x: 400},
    { bar: 79, beat: 4, semiquaver: 2, x: 400},
    { bar: 79, beat: 4, semiquaver: 3, x: 400},
    { bar: 79, beat: 4, semiquaver: 4, x: 400},

    { bar: 80, beat: 1, semiquaver: 1, x: 400}, // long note end
    { bar: 80, beat: 3, semiquaver: 1, x: 300},
    ...
    { bar: 95, beat: 1, semiquaver: 3, x: 300},
    { bar: 95, beat: 3, semiquaver: 1, x: 500},
    { bar: 95, beat: 3, semiquaver: 2, x: 500},
    { bar: 95, beat: 3, semiquaver: 3, x: 500},

    { bar: 96, beat: 1, semiquaver: 1, x: 300},
    { bar: 96, beat: 1, semiquaver: 4, x: 400},
    { bar: 96, beat: 2, semiquaver: 1, x: 400},
    { bar: 96, beat: 2, semiquaver: 3, x: 500},
    { bar: 96, beat: 2, semiquaver: 4, x: 475},
